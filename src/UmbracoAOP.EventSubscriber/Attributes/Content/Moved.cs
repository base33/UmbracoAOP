...
namespace UmbracoAOP.EventSubscriber.Attributes.ContentEvents
{
    public static partial class ContentEvent
    {
        ...
        public class Moved : Attribute, IBindToEvent
        {
            /// <summary>
            ...
            public Moved() { ContentTypeAliases = new string[] {}; }

            /// <summary>
            /// Filter by Content Type Aliases
            /// </summary>
            /// <param name="contentTypeAlias"></param>
            public Moved(params string[] contentTypeAliases)
            {
            ...
            public void Bind(MethodInfo methodToBind)
            {
                ...
                if (ContentTypeAliases.Length > 0)
                {
                    ...
                    ContentService.Moved += FilterEvent;
                }
                else
                {
                    //bind without filter
                    var eventBinder = new EventBinder();
                    eventBinder.BindToEvent(typeof(ContentService), "Moved", methodToBind);
                }
            }
