...
namespace UmbracoAOP.EventSubscriber.Attributes.ContentEvents
{
    public static partial class ContentEvent
    {
        ...
        public class Trashing : Attribute, IBindToEvent
        {
            /// <summary>
            ...
            public Trashing() { ContentTypeAliases = new string[] {}; }

            /// <summary>
            /// Filter by Content Type Aliases
            /// </summary>
            /// <param name="contentTypeAlias"></param>
            public Trashing(params string[] contentTypeAliases)
            {
            ...
            public void Bind(MethodInfo methodToBind)
            {
                ...
                if (ContentTypeAliases.Length > 0)
                {
                    ...
                    ContentService.Trashing += FilterEvent;
                }
                else
                {
                    //bind without filter
                    var eventBinder = new EventBinder();
                    eventBinder.BindToEvent(typeof(ContentService), "Trashing", methodToBind);
                }
            }
