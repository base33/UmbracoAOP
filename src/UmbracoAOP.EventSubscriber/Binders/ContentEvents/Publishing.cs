...
namespace UmbracoAOP.EventSubscriber.Attributes.ContentEvents
{
    ...
    {
        /// <summary>
        /// <para>Raised when publishing Content</para>
        ...
        public class Publishing : Attribute, IBindToEvent
        {
            /// <summary>
            ...
            public Publishing() { ContentTypeAliases = new string[] {}; }

            /// <summary>
            /// Filter by Content Type Aliases
            /// </summary>
            /// <param name="contentTypeAlias"></param>
            public Publishing(params string[] contentTypeAliases)
            {
            ...
            public void Bind(MethodInfo methodToBind)
            {
                ...
                if (ContentTypeAliases.Length > 0)
                {
                    ...
                    ContentService.Publishing += FilterEvent;
                }
                else
                {
                    //bind without filter
                    var eventBinder = new EventBinder();
                    eventBinder.BindToEvent(typeof(ContentService), "Publishing", methodToBind);
                }
            }
